namespace Dag_14_ovn_8
{
    ...
    class Land
    {
        ...
        static void Main(string[] args)
        {
            ...
            lander[3] = new Land { namn = "Danmark", styrestyp = "monarki", huvudstad = "Köpenhamn", invånartal = "5928364" };
            lander[4] = new Land { namn = "Italien", styrestyp = "republik", huvudstad = "Rom", invånartal = "58853482" };
            lander[5] = new Land { namn = "Danmark", styrestyp = "republik", huvudstad = "Prag", invånartal = "10551219" };
            lander[6] = new Land { namn = "Danmark", styrestyp = "republik", huvudstad = "Bukarest", invånartal = "19760314" };

            foreach (Land i in lander)
